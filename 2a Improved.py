...
for y in range(0, len(passwords_and_policies)):
    ...
    if password.count(character)>= min_number and password.count(character)<= max_number:
        counter +=1

del i, x, min_number, max_number, character,password

print('There are ' + str(counter) + ' good solutions ' + 'out of ' + str(len(passwords_and_policies)) + ' total for AOC 2020 Day 2 part a.')
